...
cglobal hevc_put_hevc_epel_h%1_%2, 6, 7, 11, dst, dststride, src, srcstride, height, mx, rfilter
%assign %%stride ((%2 + 7)/8)
...
cglobal hevc_put_hevc_bi_epel_h%1_%2, 7, 8, 11, dst, dststride, src, srcstride, src2, src2stride, height, mx, rfilter
    movdqa            m6, [pw_bi_%2]
    EPEL_FILTER       %2, mx, m4, m5
.loop
    EPEL_LOAD         %2, srcq-%%stride, %%stride, %1
...
cglobal hevc_put_hevc_epel_v%1_%2, 6, 7, 11, dst, dststride, src, srcstride, height, r3src, my, rfilter
    lea           r3srcq, [srcstrideq*3]
    sub             srcq, srcstrideq
...
cglobal hevc_put_hevc_bi_epel_v%1_%2, 8, 9, 11, dst, dststride, src, srcstride, src2, src2stride,height, r3src, my, rfilter
    lea           r3srcq, [srcstrideq*3]
    movdqa            m6, [pw_bi_%2]
    sub             srcq, srcstrideq
    EPEL_FILTER       %2, my, m4, m5
...
cglobal hevc_put_hevc_epel_hv%1_%2, 6, 8, 16 , dst, dststride, src, srcstride, height, mx, my, r3src, rfilter
%assign %%stride ((%2 + 7)/8)
    sub             srcq, srcstrideq
    EPEL_HV_FILTER    %2
    EPEL_LOAD         %2, srcq-%%stride, %%stride, %1
...
cglobal hevc_put_hevc_qpel_h%1_%2, 5, 6, 16, dst, dststride, src, srcstride, height, mx, rfilter
    QPEL_FILTER       %2, mx
.loop
...
cglobal hevc_put_hevc_qpel_v%1_%2, 6, 8, 16, dst, dststride, src, srcstride, height, r3src, my, rfilter
    lea           r3srcq, [srcstrideq*3]
    QPEL_FILTER       %2, my
.loop
...
cglobal hevc_put_hevc_qpel_hv%1_%2, 6, 8, 16, dst, dststride, src, srcstride, height, mx, my, r3src, rfilter
%if avx_enabled
%assign %%shift  4
%else
%assign %%shift  3
