        ...
        if (EXTERNAL_MMX(mm_flags)) {
            ...
            if (EXTERNAL_MMXEXT(mm_flags)) {
                ...
                if (EXTERNAL_SSSE3(mm_flags)) {
                    ...
                    PEL_LINK(c->put_hevc_qpel, 2, 0, 1, qpel_h8 ,  8);
                    PEL_LINK(c->put_hevc_qpel, 3, 0, 1, qpel_h8 ,  8);
                    PEL_LINK(c->put_hevc_qpel, 4, 0, 1, qpel_h8 ,  8);
                    PEL_LINK(c->put_hevc_qpel, 0, 1, 0, qpel_v4 ,  8);
                    PEL_LINK(c->put_hevc_qpel, 1, 1, 0, qpel_v8 ,  8);
                    PEL_LINK(c->put_hevc_qpel, 2, 1, 0, qpel_v8 ,  8);
                    PEL_LINK(c->put_hevc_qpel, 3, 1, 0, qpel_v8 ,  8);
                    PEL_LINK(c->put_hevc_qpel, 4, 1, 0, qpel_v8 ,  8);
                    PEL_LINK(c->put_hevc_qpel, 0, 1, 1, qpel_hv4,  8);
                    PEL_LINK(c->put_hevc_qpel, 1, 1, 1, qpel_hv8,  8);
                    PEL_LINK(c->put_hevc_qpel, 2, 1, 1, qpel_hv8,  8);
                    PEL_LINK(c->put_hevc_qpel, 3, 1, 1, qpel_hv8,  8);
                    PEL_LINK(c->put_hevc_qpel, 4, 1, 1, qpel_hv8,  8);
        ...
        if (EXTERNAL_MMX(mm_flags)) {
            if (EXTERNAL_MMXEXT(mm_flags)) {
                ...
                if (EXTERNAL_SSE4(mm_flags)) {
                    ...
                    PEL_LINK(c->put_hevc_qpel, 4, 1, 0, qpel_hv8, 10);
                    PEL_LINK(c->put_hevc_qpel, 0, 1, 1, qpel_hv4, 10);
                    PEL_LINK(c->put_hevc_qpel, 1, 1, 1, qpel_hv8, 10);
                    PEL_LINK(c->put_hevc_qpel, 2, 1, 1, qpel_hv8, 10);
                    PEL_LINK(c->put_hevc_qpel, 3, 1, 1, qpel_hv8, 10);
                    PEL_LINK(c->put_hevc_qpel, 4, 1, 1, qpel_hv8, 10);
                }
                if (EXTERNAL_AVX(mm_flags)) {
                }
            }
